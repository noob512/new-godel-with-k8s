...
var _ framework.CheckConflictsPlugin = &nonCSILimits{}
...
func (pl *nonCSILimits) CheckConflicts(ctx context.Context, s *framework.CycleState, pod *v1.Pod, nodeInfo framework.NodeInfo) *framework.Status {
