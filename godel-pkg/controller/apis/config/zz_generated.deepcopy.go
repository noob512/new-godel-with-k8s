...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GodelControllerManagerConfiguration) DeepCopyInto(out *GodelControllerManagerConfiguration) {
	*out = *in
...
func (in *GodelControllerManagerConfiguration) DeepCopy() *GodelControllerManagerConfiguration {
	if in == nil {
		return nil
	}
	out := new(GodelControllerManagerConfiguration)
	in.DeepCopyInto(out)
	return out
}
