...
func TestFailureOutput(t *testing.T) {
	...
	commonOutput := "\n\nINFO: after\nFAIL: true is never false either\nExpected\n    <bool>: true\nto equal\n    <bool>: false\n\nFull Stack Trace\ngithub.com/kubewharf/scheduler/test/e2e/framework_test.glob..func1.6()\n\tlog_test.go:44\ngithub.com/kubewharf/scheduler/test/e2e/framework_test.runTests()\n\tlog_test.go:20\n\n"

	// Sorted by name!
	expected := suiteResults{
		testResult{
			name:    "[Top Level] log asserts",
			output:  "INFO: before\nFAIL: false is never true\nExpected\n    <bool>: false\nto equal\n    <bool>: true\n\nFull Stack Trace\ngithub.com/kubewharf/scheduler/test/e2e/framework_test.glob..func1.3()\n\tlog_test.go:33\ngithub.com/kubewharf/scheduler/test/e2e/framework_test.runTests()\n\tlog_test.go:20" + commonOutput,
			failure: "false is never true\nExpected\n    <bool>: false\nto equal\n    <bool>: true",
			stack:   "github.com/kubewharf/scheduler/test/e2e/framework_test.glob..func1.3()\n\tlog_test.go:33\ngithub.com/kubewharf/scheduler/test/e2e/framework_test.runTests()\n\tlog_test.go:20\n",
		},
		testResult{
			name:    "[Top Level] log equal",
			output:  "INFO: before\nFAIL: of course it's not equal...\nExpected\n    <int>: 0\nto equal\n    <int>: 1\n\nFull Stack Trace\ngithub.com/kubewharf/scheduler/test/e2e/framework_test.glob..func1.5()\n\tlog_test.go:40\ngithub.com/kubewharf/scheduler/test/e2e/framework_test.runTests()\n\tlog_test.go:20" + commonOutput,
			failure: "of course it's not equal...\nExpected\n    <int>: 0\nto equal\n    <int>: 1",
			stack:   "github.com/kubewharf/scheduler/test/e2e/framework_test.glob..func1.5()\n\tlog_test.go:40\ngithub.com/kubewharf/scheduler/test/e2e/framework_test.runTests()\n\tlog_test.go:20\n",
		},
		testResult{
			name:    "[Top Level] log error",
			output:  "INFO: before\nFAIL: hard-coded error\nUnexpected error:\n    <*errors.errorString>: {\n        s: \"an error with a long, useless description\",\n    }\n    an error with a long, useless description\noccurred\n\nFull Stack Trace\ngithub.com/kubewharf/scheduler/test/e2e/framework_test.glob..func1.4()\n\tlog_test.go:37\ngithub.com/kubewharf/scheduler/test/e2e/framework_test.runTests()\n\tlog_test.go:20" + commonOutput,
			failure: "hard-coded error\nUnexpected error:\n    <*errors.errorString>: {\n        s: \"an error with a long, useless description\",\n    }\n    an error with a long, useless description\noccurred",
			stack:   "github.com/kubewharf/scheduler/test/e2e/framework_test.glob..func1.4()\n\tlog_test.go:37\ngithub.com/kubewharf/scheduler/test/e2e/framework_test.runTests()\n\tlog_test.go:20\n",
		},
		testResult{
			name:    "[Top Level] log fails",
			output:  "INFO: before\nFAIL: I'm failing.\n\nFull Stack Trace\ngithub.com/kubewharf/scheduler/test/e2e/framework_test.glob..func1.2.1(...)\n\tlog_test.go:29\ngithub.com/kubewharf/scheduler/test/e2e/framework_test.glob..func1.2()\n\tlog_test.go:30\ngithub.com/kubewharf/scheduler/test/e2e/framework_test.runTests()\n\tlog_test.go:20" + commonOutput,
			failure: "I'm failing.",
			stack:   "github.com/kubewharf/scheduler/test/e2e/framework_test.glob..func1.2.1(...)\n\tlog_test.go:29\ngithub.com/kubewharf/scheduler/test/e2e/framework_test.glob..func1.2()\n\tlog_test.go:30\ngithub.com/kubewharf/scheduler/test/e2e/framework_test.runTests()\n\tlog_test.go:20\n",
		},
	}
...
//
// github.com/kubewharf/scheduler/test/e2e/framework_test.TestFailureOutput(0xc000558800)
//
//	/nvme/gopath/src/github.com/kubewharf/scheduler/test/e2e/framework/log/log_test.go:73 +0x1c9
//
...
var testFailureOutput = regexp.MustCompile(`(?m)^github.com/kubewharf/scheduler/test/e2e/framework_test\.TestFailureOutput\(.*\n\t.*(\n.*\n\t.*)*`)
