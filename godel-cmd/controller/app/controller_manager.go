...
import (
	...
	clientbuilder "k8s.io/kubernetes/godel-pkg/controller/clientbuilder"
	controllerhealthz "k8s.io/kubernetes/godel-pkg/controller/healthz"
	leadermigration "k8s.io/kubernetes/godel-pkg/controller/leadermigration"
	...
	controllerappconfig "k8s.io/kubernetes/godel-cmd/controller/app/config"
	"k8s.io/kubernetes/godel-cmd/controller/app/options"
