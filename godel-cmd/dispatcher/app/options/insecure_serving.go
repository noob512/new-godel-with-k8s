...
func (o *CombinedInsecureServingOptions) applyTo(c *dispatcherappconfig.Config, componentConfig *godeldispatcherconfig.GodelDispatcherConfiguration) error {
...
func (o *CombinedInsecureServingOptions) ApplyToFromLoadedConfig(c *dispatcherappconfig.Config, componentConfig *godeldispatcherconfig.GodelDispatcherConfiguration) error {
	if o == nil {
		return nil
	}
